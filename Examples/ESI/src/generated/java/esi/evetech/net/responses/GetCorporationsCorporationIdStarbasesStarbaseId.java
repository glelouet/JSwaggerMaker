...
import esi.evetech.net.structures.GetCorporationsCorporationIdStarbasesStarbaseIdAnchor;
import esi.evetech.net.structures.GetCorporationsCorporationIdStarbasesStarbaseIdFuelBayTake;
import esi.evetech.net.structures.GetCorporationsCorporationIdStarbasesStarbaseIdFuelBayView;
import esi.evetech.net.structures.GetCorporationsCorporationIdStarbasesStarbaseIdOffline;
import esi.evetech.net.structures.GetCorporationsCorporationIdStarbasesStarbaseIdOnline;
import esi.evetech.net.structures.GetCorporationsCorporationIdStarbasesStarbaseIdUnanchor;

public class GetCorporationsCorporationIdStarbasesStarbaseId {
    /**
     ...
     */
    public GetCorporationsCorporationIdStarbasesStarbaseIdAnchor anchor;
    /**
     ...
     */
    public GetCorporationsCorporationIdStarbasesStarbaseIdFuelBayTake fuel_bay_take;
    /**
     * Who can view the starbase (POS)'s fule bay. Characters either need to have required role or belong to the starbase (POS) owner's corporation or alliance, as described by the enum, all other access settings follows the same scheme
     */
    public GetCorporationsCorporationIdStarbasesStarbaseIdFuelBayView fuel_bay_view;
    /**
     * Fuel blocks and other things that will be consumed when operating a starbase (POS)
     */
    public GetCorporationsCorporationIdStarbasesStarbaseIdFuels[] fuels;
    /**
     * Who can offline starbase (POS) and its structures
     */
    public GetCorporationsCorporationIdStarbasesStarbaseIdOffline offline;
    /**
     * Who can online starbase (POS) and its structures
     */
    public GetCorporationsCorporationIdStarbasesStarbaseIdOnline online;
    /**
     * Who can unanchor starbase (POS) and its structures
     */
    public GetCorporationsCorporationIdStarbasesStarbaseIdUnanchor unanchor;
    /**
    ...
    public boolean equals(Object other) {
        ...
        GetCorporationsCorporationIdStarbasesStarbaseId othersame = ((GetCorporationsCorporationIdStarbasesStarbaseId) other);
