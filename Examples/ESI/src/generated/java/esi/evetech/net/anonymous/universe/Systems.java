    ...
    extends DelegateTransfer<Anonymous>
{
    ...
    public Requested<int[]> get(String If_None_Match) {
        String url = ("https://esi.evetech.net/v1/universe/systems/"+"?"+(delegate.datasource==null?"":"&datasource="+flatten(delegate.datasource)));
    ...
    public Requested<GetUniverseSystemsSystemId> getBySystemId(esi.evetech.net.structures.Accept_Language Accept_Language,
        ...
        int system_id) {
        String url = ("https://esi.evetech.net/v4/universe/systems/{system_id}/".replace("{system_id}", ""+system_id)+"?"+(delegate.datasource==null?"":"&datasource="+flatten(delegate.datasource))+(language==null?"":"&language="+flatten(language)));
        HashMap<String, String> headerProperties = new HashMap<String, String>();
        if (If_None_Match!= null) {
            headerProperties.put("If-None-Match", (""+ If_None_Match));
        }
