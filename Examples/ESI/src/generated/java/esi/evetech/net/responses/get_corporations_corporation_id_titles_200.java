...
import esi.evetech.net.structures.get_corporations_corporation_id_titles_grantable_roles;
import esi.evetech.net.structures.get_corporations_corporation_id_titles_grantable_roles_at_base;
import esi.evetech.net.structures.get_corporations_corporation_id_titles_grantable_roles_at_hq;
import esi.evetech.net.structures.get_corporations_corporation_id_titles_grantable_roles_at_other;
import esi.evetech.net.structures.get_corporations_corporation_id_titles_roles;
import esi.evetech.net.structures.get_corporations_corporation_id_titles_roles_at_base;
import esi.evetech.net.structures.get_corporations_corporation_id_titles_roles_at_hq;
import esi.evetech.net.structures.get_corporations_corporation_id_titles_roles_at_other;

public class get_corporations_corporation_id_titles_200 {
    /**
    ...
    public boolean equals(Object other) {
        ...
        get_corporations_corporation_id_titles_200 othersame = ((get_corporations_corporation_id_titles_200) other);
