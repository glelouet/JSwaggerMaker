...
public enum get_corporations_corporation_id_wallets_division_journal_context_id_type {
    ...
    get_corporations_corporation_id_wallets_division_journal_context_id_type(String toString) {
