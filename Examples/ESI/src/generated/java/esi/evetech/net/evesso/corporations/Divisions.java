    ...
    extends DelegateTransfer<Evesso>
{
    ...
    public Divisions(Evesso delegate) {
        super(delegate);
    }
    ...
    public Requested<GetCorporationsCorporationIdDivisions> getByCorporationId(int corporation_id, String If_None_Match) {
        String url = ("https://esi.evetech.net/v1/corporations/{corporation_id}/divisions/".replace("{corporation_id}", ""+corporation_id)+"?"+(delegate.datasource==null?"":"&datasource="+flatten(delegate.datasource))+(delegate.token==null?"":"&token="+flatten(delegate.token)));
