...
public enum get_corporations_corporation_id_starbases_starbase_id_unanchor {
    ...
    get_corporations_corporation_id_starbases_starbase_id_unanchor(String toString) {
