...
public enum get_corporations_corporation_id_starbases_starbase_id_fuel_bay_take {
    ...
    get_corporations_corporation_id_starbases_starbase_id_fuel_bay_take(String toString) {
