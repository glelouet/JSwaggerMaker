    ...
    extends DelegateTransfer<Evesso>
{
    ...
    public Attributes(Evesso delegate) {
        super(delegate);
    }
    ...
    public Requested<GetCharactersCharacterIdAttributes> getByCharacterId(int character_id, String If_None_Match) {
        String url = ("https://esi.evetech.net/v1/characters/{character_id}/attributes/".replace("{character_id}", ""+character_id)+"?"+(delegate.datasource==null?"":"&datasource="+flatten(delegate.datasource))+(delegate.token==null?"":"&token="+flatten(delegate.token)));
