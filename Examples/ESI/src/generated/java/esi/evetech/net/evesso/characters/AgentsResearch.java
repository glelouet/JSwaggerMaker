    ...
    extends DelegateTransfer<Evesso>
{
    ...
    public AgentsResearch(Evesso delegate) {
        super(delegate);
    }
    ...
    public Requested<GetCharactersCharacterIdAgentsResearch[]> getByCharacterId(int character_id, String If_None_Match) {
        String url = ("https://esi.evetech.net/v1/characters/{character_id}/agents_research/".replace("{character_id}", ""+character_id)+"?"+(delegate.datasource==null?"":"&datasource="+flatten(delegate.datasource))+(delegate.token==null?"":"&token="+flatten(delegate.token)));
