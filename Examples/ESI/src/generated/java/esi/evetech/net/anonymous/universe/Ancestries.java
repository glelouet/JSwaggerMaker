    ...
    extends DelegateTransfer<Anonymous>
{
    ...
    public Ancestries(Anonymous delegate) {
        super(delegate);
    }
    ...
    public Requested<GetUniverseAncestries[]> get(esi.evetech.net.structures.Accept_Language Accept_Language, String If_None_Match, esi.evetech.net.structures.language language) {
        String url = ("https://esi.evetech.net/v1/universe/ancestries/"+"?"+(delegate.datasource==null?"":"&datasource="+flatten(delegate.datasource))+(language==null?"":"&language="+flatten(language)));
