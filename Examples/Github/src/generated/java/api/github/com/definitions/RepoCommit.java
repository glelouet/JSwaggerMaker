...
public class RepoCommit {
    ...
    public boolean equals(Object other) {
        ...
        RepoCommit othersame = ((RepoCommit) other);
    ...
    public int hashCode() {
        return ((((((((author == null)? 0 :author.hashCode())+((committer == null)? 0 :committer.hashCode()))+((message == null)? 0 :message.hashCode()))+((parents == null)? 0 :parents.hashCode()))+((sha == null)? 0 :sha.hashCode()))+((tree == null)? 0 :tree.hashCode()))+((url == null)? 0 :url.hashCode()));
    }
}
