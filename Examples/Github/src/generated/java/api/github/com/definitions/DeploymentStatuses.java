...
public class DeploymentStatuses {
    ...
    public boolean equals(Object other) {
        ...
        DeploymentStatuses othersame = ((DeploymentStatuses) other);
    ...
    public int hashCode() {
        return ((((((((((created_at == null)? 0 :created_at.hashCode())+((creator == null)? 0 :creator.hashCode()))+((description == null)? 0 :description.hashCode()))+ Long.hashCode(id))+((payload == null)? 0 :payload.hashCode()))+((state == null)? 0 :state.hashCode()))+((target_url == null)? 0 :target_url.hashCode()))+((updated_at == null)? 0 :updated_at.hashCode()))+((url == null)? 0 :url.hashCode()));
    }
}
