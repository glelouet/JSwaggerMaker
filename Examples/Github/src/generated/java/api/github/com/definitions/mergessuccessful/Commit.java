package api.github.com.definitions.mergessuccessful;
...
public class Commit {
    ...
    public boolean equals(Object other) {
        ...
        if (comment_count!= othersame.comment_count) {
            return false;
        }
    ...
    public int hashCode() {
        return (((((((author == null)? 0 :author.hashCode())+ Long.hashCode(comment_count))+((committer == null)? 0 :committer.hashCode()))+((message == null)? 0 :message.hashCode()))+((tree == null)? 0 :tree.hashCode()))+((url == null)? 0 :url.hashCode()));
    }
}
